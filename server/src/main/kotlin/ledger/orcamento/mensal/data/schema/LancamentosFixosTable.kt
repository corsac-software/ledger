...
fun LancamentoFixo.toStatement(stmt: UpdateBuilder<*>) {
    ...
    stmt[LancamentosFixosTable.cartaoId] = this.idCartao
    stmt[LancamentosFixosTable.categoriaId] = this.idCategoria
    stmt[LancamentosFixosTable.ativo] = this.ativo
    stmt[LancamentosFixosTable.criadoEm] = this.criadoEm
    stmt[LancamentosFixosTable.atualizadoEm] = this.atualizadoEm
    stmt[LancamentosFixosTable.excluidoEm] = this.excluidoEm?.toFormatoSlug()
}
