...
fun Parcelamento.toStatement(stmt: UpdateBuilder<*>) {
    stmt[ParcelamentosTable.cartaoId] =
        this.idCartao
    stmt[ParcelamentosTable.nome] = this.nome
    stmt[ParcelamentosTable.valor] = this.valor
    stmt[ParcelamentosTable.parcelas] =
        this.parcelas
    stmt[ParcelamentosTable.mesInicio] =
        this.mesInicio.toFormatoSlug()
    stmt[ParcelamentosTable.ativo] = this.ativo
    stmt[ParcelamentosTable.criadoEm] =
        this.criadoEm
    stmt[ParcelamentosTable.atualizadoEm] =
        this.atualizadoEm
    stmt[ParcelamentosTable.excluidoEm] =
        this.excluidoEm
}
