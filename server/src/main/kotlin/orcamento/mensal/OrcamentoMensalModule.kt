package br.dev.corsac.ledger.orcamento.mensal

import br.dev.corsac.ledger.orcamento.mensal.api.*
import br.dev.corsac.ledger.orcamento.mensal.data.gerarOrcamentoMensalMigrationScripts
import br.dev.corsac.ledger.orcamento.mensal.data.repository.*
import br.dev.corsac.ledger.orcamento.mensal.routes.cartoesRoutes
import br.dev.corsac.ledger.orcamento.mensal.routes.categoriasRoutes
import br.dev.corsac.ledger.orcamento.mensal.routes.lancamentosFixosRoutes
import br.dev.corsac.ledger.orcamento.mensal.routes.orcamentosMensaisRoutes
import br.dev.corsac.ledger.orcamento.mensal.service.OrcamentosMensaisService
import br.dev.corsac.ledger.orcamento.mensal.service.cartoes.CartoesCrudService
import br.dev.corsac.ledger.orcamento.mensal.service.cartoes.FaturasCrudService
import br.dev.corsac.ledger.orcamento.mensal.service.cartoes.ParcelamentosCrudService
import br.dev.corsac.ledger.orcamento.mensal.service.lancamentos.CategoriasCrudService
import br.dev.corsac.ledger.orcamento.mensal.service.lancamentos.LancamentosFixosCrudService
import br.dev.corsac.ledger.orcamento.mensal.service.lancamentos.LancamentosMensaisService
import br.dev.corsac.ledger.utils.withMigrationGenerationEnabled
